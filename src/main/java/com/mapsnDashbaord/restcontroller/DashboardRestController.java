package com.mapsnDashbaord.restcontroller;

import com.fasterxml.jackson.annotation.JsonAutoDetect;
import com.mapsnDashbaord.repository.*;
...
public class DashboardRestController {
    ...
    public HashMap<String, Object> getDashboardStatistics(){
        ...
        long lRegionCount=iRegionRepository.count();
        long lDepartementCount=depRepository.count();
        long lArrondissementCount=arrondissementRepository.count();
        long lCommunCount=communRepository.count();
        long lVisitorsCount = 0;

        HashMap<String, Object> map = new HashMap<>();

        map.put("count_user", lUserCount);
        map.put("count_region", lRegionCount);
        map.put("count_departement", lDepartementCount);
        map.put("count_arrondissement", lArrondissementCount);
        map.put("count_commun", lCommunCount);
