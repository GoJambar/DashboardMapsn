  ...
  function getDashboardStatistics(){
      $.ajax({
          ...
          //context: document.body
            ...
            //debugger;
          $('#count_region').text(data.count_region);
          $('#count_departement').text(data.count_departement);
            $('#count_arrondissement').text(data.count_arrondissement);
            $('#count_commun').text(data.count_commun);
